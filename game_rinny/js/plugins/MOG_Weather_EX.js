 ...
 * =============================================================================
 * 添加新的天气效果。
 * 天气图像必须保存在文件夹中: (img/weather/)
 *
 * =============================================================================
 * - 地图
 * =============================================================================
 * 要激活天气功能，请通过插件命令功能使用下面的注释
 *
 * weather ID : TYPE : POWER : SPEED : BLEND_TYPE : FILE_NAME 
 *
 *
 * -> ID - 设置气候 ID，您最多可以同时使用 10 种不同的气候。
 * 同时使用。
 *
 * -> 类型 - 效果 (de 0 a 29)
 *        0 -  Wind 1 (下落)
 ...
 *        24 - LightSpeed
 *        25 - Shooting Star 1
 *        26 - Shooting Star 2 (旋转)
 *        27 - Shinning 
 *        28 - Bouncing
 *        29 - Spark 4 (魔力场 2/对角线)
 *        30 - Bubbles
 *        31 - StandStill
 *        32 - Fog XP Style (水平滚动)
 *        33 - Fog XP Style (垂直滚动) 
 *        35 - Overlay 1 
 *        36 - Overlay 2 
 *
 * -> POWER - 气候动力（粒子数）（1 至 2000）
 * 
 * -> SPEED - 设置动画速度（0% 至 1000%）
 *
 * -> BLEND_TYPE - 混合类型（0 至 1）  
 * 
 * -> FILE_NAME = 图像文件名
 *
 * -------------------------------------
